    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a Clam address (e.g. xAwamX1DminMPVmM2y5LhEszYG7menCKkM)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a Clam address (e.g. xAwamX1DminMPVmM2y5LhEszYG7menCKkM)"));
